...
<div id="body-container">
	...
	<div id="header-container">
		<header class="cf">
			...
			<div id="logo-wrap">
				<div style="text-align:left;" id="site-title">
	<a href="http://thonsaidd.com/" title="THONSAI">
		<span style="font-size:1.1em;color:#F4FA58;">THONSAI </span>
		<span style="font-size:0.5em;color:#F4FA58;">design & development ltd., part</span>
	</a>
</div>
<div style="text-align:left;">
	<span style="font-size:1em;color:white;">รับทำเสื้อยืด เสื้อโปโล ยูนิฟอร์ม ถุงผ้า และงานผ้าทุกรูปแบบ พร้อมโลโก้ ลายปัก และลายสกรีน งานคุณภาพ ราคาโรงงาน</span>
</div>
				<!-- Silp add comment:  <?php
